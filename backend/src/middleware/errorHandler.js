 ...
 *
 * Use for business-logic errors that should return a specific HTTP status.
 * Marked as "operational" to distinguish from programming bugs.
 *
 * Usage:
 *   throw new AppError('Employee not found', 404);
 *   throw new AppError('Over-allocation: total exceeds 100%', 400);
 */
